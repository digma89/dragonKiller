...
public class DragonController : MonoBehaviour {
    ...
    public Transform FireBall;        // The laser we will be shooting
    private float fireDistance = 50f;         // How far from the center of the ship should the laser be
    ...
    public List<KeyCode> shootButton;        // The buttons that we can use to shoot lasers
